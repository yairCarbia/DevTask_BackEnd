...
const obtenerProyecto = async (req, res) => {
    ...
    if (
        proyectoExiste.creador.toString() !== req.usuario._id.toString() &&
        !proyectoExiste.colaboradores.some(
...
const obtenerTareas = async (req, res) => {
    ...
    //Ser creador del proyecto o colaborador.
